...
export const Route = createFileRoute("/employee2")({
  head: () => ({
    meta: [
...
function EmployeeHome2() {
  ...
  // ── Supervisor3-style hero sub-sections ───────────────────────────────────
  ...
  const yourAssignment = (
    <div className="bg-white rounded-lg p-5 shadow-sm border border-border flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 flex gap-4 min-h-0">
        ...
        {/* Right column — notification + vertical timeline */}
  ...
  return (
    <div className="min-h-screen bg-brand-canvas">
      ...
      <main className="max-w-[1400px] mx-auto px-8 py-8 space-y-6">
        ...
        {/* Hero — [Your Assignment] | [Help & Resources] */}
        ...
        {/* Things to do */}
        <section className="bg-white rounded-lg p-5 shadow-sm border border-border">
          ...
          <Tabs value={todoTab} onValueChange={(v) => setTodoTab(v as TodoTabKey)}>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-6 items-start">
          ...
          {/* Help & Resources (full-size, below hero) */}
          <div>
